...
KERNELS = {
    ...
    "cutile_v3_tiled_loads":   KernelSpec(MPMSolver, cutile_v3_backend),
    "cutile_v4_native4":       KernelSpec(MPMSolver, cutile_v4_native4_backend),
    "cutile_v5_sc4_tiledview_flush": KernelSpec(MPMSolver, cutile_v5_sc4_tiledview_flush_backend),
    "cutile_v6_sc4_colored_tiledview_store": KernelSpec(MPMSolver, cutile_v6_sc4_colored_tiledview_store_backend),
    "cutile_v7_sc4_colored_arena256_store": KernelSpec(MPMSolver, cutile_v7_sc4_colored_arena256_store_backend),
