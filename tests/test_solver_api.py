...
from mpm_jax.p2g.backends.cuda import CudaV3Backend
...
def test_solver_validates_cuda_v3_against_runtime_num_grids(monkeypatch):
    ...
    material = SimpleNamespace(elasticity=stvk_elasticity_jacobi())
    backend = CudaV3Backend(num_grids=None)
